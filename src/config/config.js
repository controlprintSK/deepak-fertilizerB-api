...
const envVarsSchema = Joi.object()
  .keys({
    ...
    UAT_URL: Joi.string().description('User acceptance URL (Testing url)'),
    PROD_URL: Joi.string().description('Production URL'),
    LOCAL_AUTH_TOKEN: Joi.string().description('LOCAL AUTH URL'),
  })
  .unknown();
...
module.exports = {
  ...
  testingURL: envVars.UAT_URL,
  productionURL: envVars.PROD_URL,
  localAuthUrl: envVars.LOCAL_AUTH_TOKEN,
};
